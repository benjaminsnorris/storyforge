...
2. **Read `reference/scenes.csv`** — how many scenes, their status (drafted/revised/pending), groupings (acts/parts).
...
- `scenes` — semicolon-separated ordered list of scene IDs from scenes.csv
