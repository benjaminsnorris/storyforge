...
Load Storyforge directly from your local checkout:
...
Edits take effect in your next Claude Code session.

### For distribution (future)

Storyforge can be distributed via a Claude Code marketplace:
